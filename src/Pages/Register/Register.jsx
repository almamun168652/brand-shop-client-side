                ...
                <div className="relative flex flex-col p-4 shadow-md border rounded-lg bg-transparent bg-clip-border text-gray-700">
                        ...
                        <div className="mb-4 flex flex-col gap-6">
                            <div className="relative h-11 w-full min-w-[200px]">
                                <input type="text" name="name"
                                    className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-sky-700 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-sky-700  focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                />
                    ...
                    <div className="flex flex-col items-center justify-center gap-4">
                        <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                            Already have an account? please<Link className="font-semibold text-sky-700" to='/login'> Sign In</Link>
                        </p>
