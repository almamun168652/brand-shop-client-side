        ...
        try {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const response = await fetch(`https://brand-shop-server-etvnzft76-almamun168652-gmailcom.vercel.app/carts/${_id}`, {
                        method: "DELETE",
                    });
                ...
                <div className="p-6 w-3/5">
                    ...
                    <div className='flex justify-end'>
                        <div onClick={() => hanldeDelete(_id)}>
                            <button type="button" className="text-white bg-sky-700 hover:bg-sky-800 border border-sky-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Delete</button>
                        </div>
                    </div>
